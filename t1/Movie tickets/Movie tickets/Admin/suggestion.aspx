...
<h1>Suggestion</h1>
      ...
      <asp:TextBox ID="TextSearch" runat="server" placeholder="Search by Movie Type" CssClass="textbox" OnTextChanged="TextSearch_TextChanged"></asp:TextBox><asp:Button ID="ButtonSearch" runat="server" Text="Search" CssClass="btn_search" OnClick="ButtonSearch_Click" /><br /><br />
    <div class="container"> 
